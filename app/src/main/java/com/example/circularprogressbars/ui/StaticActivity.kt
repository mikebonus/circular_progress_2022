...
// (The higher the value, the slower the rotation, the lower the value, the faster the rotation)
private const val RotationDuration = 4000

// StartAngleOffsetOne and StartAngleOffsetTwo must be the OPPOSITE so that there are
// two strokes on the opposite sides
private const val StartAngleOffsetOne = -90f
private const val StartAngleOffsetTwo = 90f

// How far the base point moves around the circle (Default value: 286)
// (The higher the faster, the lower the slower)
private const val BaseRotationAngle = 300f

// The Length of each of the two strokes:
// 290f is the default value but 50f looks reasonable
private const val JumpRotationAngle = 60f
...
private fun DrawScope.drawIndeterminateCircularIndicator(
    ...
    // Set the adjustedSweep to '90f' for CONSTANT stroke-length
    // instead of the default value 'max(sweep, 0.1f)'
    val adjustedSweep = 90f
