...
private const val StartAngleOffsetOne = 0f
private const val StartAngleOffsetTwo = 120f
private const val StartAngleOffsetThree = 240f
...
@Composable
fun MoreStrokesCircularProgressBar() {
...
@Composable
fun MoreStrokesProgressIndicator(
    ...
    val currentRotationThree by transition.animateValue(
        0,
        RotationDuration,
        Int.VectorConverter,
        infiniteRepeatable(
    ...
    val baseRotationThree by transition.animateFloat(
        0f,
        BaseRotationAngle,
        infiniteRepeatable(
            animation = tween(
    ...
    val endAngleThree by transition.animateFloat(
        0f,
        JumpRotationAngle,
        infiniteRepeatable(
            animation = keyframes {
    ...
    val startAngleOne by transition.animateFloat(
        ...
        infiniteRepeatable(
            animation = keyframes {
                durationMillis = HeadAndTailAnimationDuration + HeadAndTailDelayDuration
                0f at HeadAndTailDelayDuration with LinearOutSlowInEasing
    ...
    val startAngleThree by transition.animateFloat(
        0f,
        JumpRotationAngle,
        infiniteRepeatable(
            animation = keyframes {
    ...
    Canvas(
        ...
        val currentRotationAngleOffsetThree = (currentRotationThree * RotationAngleOffset) % 360f
        val sweepThree = abs(endAngleThree - startAngleThree)
        val offsetThree = StartAngleOffsetThree + currentRotationAngleOffsetThree + baseRotationThree
        drawIndeterminateCircularIndicator(
            startAngleThree + offsetThree,
            strokeWidth,
            sweepThree,
            color,
            stroke
